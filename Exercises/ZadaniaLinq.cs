...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie09_TrzyNajnowszeZapisy()
    {
        return DaneUczelni.Zapisy
            ...
            .Take(3)
            .Select(z => $"Data: {z.DataZapisu:yyyy-MM-dd} | StudentId: {z.StudentId}");
    ...
    public IEnumerable<string> Zadanie13_GrupowanieZapisowWedlugPrzedmiotu()
    {
        return DaneUczelni.Zapisy
            ...
            .GroupBy(nazwa => nazwa)
            .Select(g => $"{g.Key} | {g.Count()} zapisow");
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        ...
        return DaneUczelni.Zapisy
            ...
            .GroupBy(x => x.Nazwa)
            .Select(g => $"{g.Key} : srednia {g.Average(x => x.Ocena):F2}");
    ...
    public IEnumerable<string> Zadanie15_ProwadzacyILiczbaPrzedmiotow()
    {
        return DaneUczelni.Prowadzacy
            .GroupJoin(DaneUczelni.Przedmioty,
                pr => pr.Id,
                p => p.ProwadzacyId,
                (pr, przedmioty) => $"{pr.Imie} {pr.Nazwisko} | liczba przedmiotow: {przedmioty.Count()}");
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Zapisy
            .Where(z => z.OcenaKoncowa.HasValue)
            .Join(DaneUczelni.Studenci, z => z.StudentId, s => s.Id, (z, s) => new { s.Imie, s.Nazwisko, Ocena = z.OcenaKoncowa.Value })
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Select(g => $"{g.Key.Imie} {g.Key.Nazwisko} | najwyzsza ocena koncowa: {g.Max(x => x.Ocena)}");
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(DaneUczelni.Studenci, z => z.StudentId, s => s.Id, (z, s) => new { s.Imie, s.Nazwisko })
            .GroupBy(x => new { x.Imie, x.Nazwisko })
            .Where(g => g.Count() > 1)
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .Where(p => DaneUczelni.Zapisy .Where(z => z.PrzedmiotId == p.Id)
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy.Select(pr =>
        {
            var oceny = DaneUczelni.Przedmioty
                ...
                .ToList();
            string wynikSredniej = oceny.Any() ? oceny.Average().ToString("F2") : "brak ocen";
            return $"{pr.Imie} {pr.Nazwisko} |  srednia: {wynikSredniej}"; });
    ...
    public IEnumerable<string> Wyzwanie04_MiastaILiczbaAktywnychZapisow()
    {
        ...
        return DaneUczelni.Studenci
            ...
            .Select(g => $"{g.Key} | liczba aktywnych zapisow: {g.Count()}");
